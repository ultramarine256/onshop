...
import { AuthGuard } from '../domain';
import { PurchaseReturnsComponent } from './pages/purchase-returns';
import { CategoriesComponent } from './pages/categories';
import { SubCategoriesComponent } from './pages/sub-categories';
import { ProductDetailsComponent } from './pages/product-details';
import { SearchResultComponent } from './pages/search-result';
